...
public class LuaIcons {
    // All tool windows should have icon size of 13x13 pixels and
    // all actions should have icon size of 16x16 pixels
    // xxx.png xxx@2x.png xxx_dark.png xxx@2x_dark.png
